      ...
      <div className='m-auto flex justify-between items-center max-w-[1200px] h-20 pl-4 pr-4 sm:pl-2 sm:pr-2 '>
        ...
        <Sheet>
            ...
            <SheetContent className='dark:bg-zinc-900'>
              <SheetHeader>
                <SheetTitle className='text-2xl pt-8 font-bold text-black dark:text-white'>YJIN의 블로그입니다.</SheetTitle>
                <SheetDescription className='pt-10 pb-2 cursor-pointer text-xl text-black hover:underline dark:text-white dark:hover:underline underline-offset-8 dark:hover:text-gray-100 hover:text-gray-300'>
                  Home
                </SheetDescription>
                {Links.map((link) => {
                  return <SheetDescription key={link.title} className='cursor-pointer text-xl text-black hover:underline dark:text-white dark:hover:underline underline-offset-8 dark:hover:text-gray-100 hover:text-gray-300 pb-2'>
